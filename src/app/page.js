...
<div className="bg-gray-50 p-6 rounded-lg mt-8">
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex flex-col justify-center items-center text-center space-y-4">
      ...
      {/* Order Form Modal */}
      {showForm && (
  <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex flex-col items-center p-4 z-50 overflow-y-auto">
    <div
      className="bg-white rounded-xl w-full max-w-5xl relative my-auto lg:my-8"
    ...
    >
      ...
      {success ? (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* Left Column - Form */}
          <div className="pt-16 px-6 pb-6 lg:p-8 flex flex-col justify-center items-center">
          ...
          <div className="bg-gray-50 flex flex-col justify-center items-center p-6 lg:p-8">
